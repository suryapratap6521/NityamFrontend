...
const Events = () => {
        ...
        const fetchData = async () => {
            try {
                if (!loading) {
                    ...
                    await fetchEventsByUser(user._id, token, dispatch);
                }
            } catch (error) {
                console.error(error);
            }
    ...
    const handleEventClick = (event) => {
        dispatch(setEventData(event)); // Set the clicked event's data
    };
    ...
    return (
        <div className="h-screen md:mb-0 mb-14 bg-white flex justify-around w-full">
            ...
            <div className="w-full md:w-9/12 md:py-4 md:px-16 md:pl-24 p-4 md:mt-5 mt-2 lg:mb-0 mb-14">
