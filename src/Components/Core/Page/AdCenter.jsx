...
const AdCenter = () => {
  ...
  const handleStateChange = (selectedState) => {
    ...
    dispatch(setAdData({ state: selectedState.map((state) => state.label) })); // Handle multiple states
    setSelectedCities([]); // Reset city selection when state changes
    dispatch(setAdData({ city: [] })); // Reset city in Redux
  };

  const handleCityChange = (selectedCity) => {
    setSelectedCities(selectedCity);
    dispatch(setAdData({ city: selectedCity.map((city) => city.label) })); // Handle multiple cities
  };
  const businessTypes = [
    "Contact Us",
    "Send Enquiry",
  ...
  const handleNext = (event) => {
    ...
    let isValid = true;
    if (step == 1) {
      if (adData.title == "" || adData.title == undefined) {
      ...
      if (adData.description == "" || adData.description == undefined) {
      ...
      if (adData.type == "" || adData.type == undefined) {
      ...
      if (adData.value == "" || adData.value == undefined) {
      ...
      if (adData.images == "" || adData.images == undefined || adData.images.length == 0) {
    ...
    if (step == 2) {
      if (adData.audianceType == "" || adData.audianceType == undefined) {
      ...
      if (adData.audianceType == "byCommunity" && (adData.communities == "" || adData.communities.length == 0 || adData.communities == undefined)) {
      ...
      if (adData.minAge == "" || adData.minAge == undefined) {
      ...
      if (adData.maxAge == "" || adData.maxAge == undefined) {
      ...
      if (adData.startDate == "" || adData.startDate == undefined) {
      ...
      if (adData.endDate == "" || adData.endDate == undefined) {
      ...
      if (adData.start == "" || adData.start == undefined) {
      ...
      if (adData.end == "" || adData.end == undefined) {
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            {step === 2 && (<>
              ...
              <div className="flex items-center justify-center gap-2 mb-4">
                {adData.audianceType === "byState" || adData.audianceType === "byCity" ? (<div className="flex-1">
                  <div className="">
                ...
                {adData.audianceType === "byCity" ? (<div className="flex-1">
                  <div className=" ">
                ...
                {adData.audianceType === "byCommunity" ? (<div className="flex-1">
              ...
              <div className="flex items-baseline mb-4">
                <div className="flex flex-col w-[48%]">
                  <div className=" flex gap-6 items-center flex-1 border rounded w-full py-3 px-4 pr-6 border-gray-300 bg-[#FAFAFA] ">
                    <label htmlFor="minAge" className="block text-base text-[#838383] text-nowrap mb-0">Minimum Age</label>
                    <input
                      type="number"
                      id="minAge"
                      name="minAge"
                ...
                <div className="flex flex-col w-[48%]">
                  <div className=" flex gap-6 items-center flex-1 border rounded w-full py-3 px-4 pr-6 border-gray-300 bg-[#FAFAFA] ">
                    <label htmlFor="maxAge" className="block text-base text-[#838383] text-nowrap mb-0">Maximum Age</label>
                    <input
                      type="number"
                      id="maxAge"
                      name="maxAge"
              ...
              <div className="flex items-baseline mb-4">
                <div className="flex flex-col w-[48%]">
                  <div className=" flex gap-6 items-center flex-1 border rounded w-full py-3 px-4 pr-6 border-gray-300 bg-[#FAFAFA] ">
                    <label htmlFor="start" className="flex justify-between text-base text-[#838383] text-nowrap mb-0 w-full">From
                      <input
                        type="time"
                        id="start"
                        name="start"
                ...
                <div className="flex flex-col w-[48%]">
                  <div className=" flex gap-6 items-center flex-1 border roundedw-[48%]  py-3 px-4 pr-6 border-gray-300 bg-[#FAFAFA] ">
                    <label htmlFor="end" className="flex justify-between text-base text-[#838383] text-nowrap mb-0 w-full">To
                      <input
                        type="time"
                        id="end"
                        name="end"
