                  ...
                  {currentPost.mediaPreviews.map((preview, index) => (
                    <div key={index} className="relative group">
                      ...
                      <button
                        ...
                        className="absolute top-0 right-0 bg-red-500 text-white rounded-full w-0 h-0 flex items-center justify-center"
                      >
          ...
          {activeTab === "poll" && (
            <div className="space-y-4">
              <input
                ...
                onChange={(e) =>
                  setCurrentPoll((prev) => ({ ...prev, title: e.target.value }))
                }
